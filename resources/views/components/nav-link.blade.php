...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-cinema-red text-sm font-medium leading-5 text-cinema-gold focus:outline-none focus:border-cinema-red transition duration-150 ease-in-out'
