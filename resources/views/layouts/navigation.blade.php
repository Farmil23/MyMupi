<nav x-data="{ open: false }" class="bg-cinema-800 border-b border-cinema-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <x-application-logo class="block h-10 w-auto fill-current text-cinema-gold" />
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-300 underline hover:text-cinema-gold">Log in</a>
                    <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-300 underline hover:text-cinema-gold">Register</a>
                @endauth
            </div>
